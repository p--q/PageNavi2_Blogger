...
a.forEach(function(a){b.appendChild(a)});b.style.padding="0px 5px";b.style.display="flex";b.style.justifyContent="center";b.style.alignItems="center";b.style.transform="scaleX(0.9)";var d;c.elements.forEach(function(a){a.textContent=null;d=b.cloneNode(!0);d.onclick=n;a.appendChild(d)})}var h={defaults:{perPage:7,numPages:5},callback:{getURL:function(a){a=/(\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\d)\.\d\d\d(.\d\d:\d\d)/i.exec(a.feed.entry[0].published.$t);var b=encodeURIComponent(a[1]+a[2]);a="/search/label/"+
c.postLabel+"?updated-max="+b+"&max-results="+c.perPage+"#PageNo="+c.pageNo;b="/search?updated-max="+b+"&max-results="+c.perPage+"#PageNo="+c.pageNo;location.href=c.postLabel?a:b},getTotalPostCount:function(a){var b=parseInt(a.feed.openSearch$totalResults.$t,10);a=[];var d=c.numPages,g=Math.floor(d/2),e=c.currentPageNo-g;1>e&&(e=1);b=Math.ceil(b/c.perPage);d=e+d-1;d>b&&(d=b);1<e&&a.push(f(1,1));3==e&&a.push(f(2,2));if(3<e){var h=e-c.jumpPages+g;2>h?a.push(f(1,"\u00ab")):a.push(f(h,"\u00ab"))}for(;e<=
d;e++)a.push(e==c.currentPageNo?m(e):f(e,e));d==b-2&&a.push(f(b-1,b-1));d<b-2&&(g=d+1+g,g>b&&(g=b),a.push(f(g,"\u00bb")));d<b&&a.push(f(b,b));p(a)}},all:function(a){a.forEach(function(a){(a=document.getElementById(a))&&c.elements.push(a)});0<c.elements.length&&l()}},c={perPage:h.defaults.perPage,numPages:h.defaults.numPages,jumpPages:h.defaults.numPages,postLabel:null,pageNo:null,currentPageNo:null,elements:[]};return h}();PageNavi2_Blogger.all(["blog-pager","blog-pager2"]);
